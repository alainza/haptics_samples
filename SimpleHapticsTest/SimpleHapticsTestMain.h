...
namespace SimpleHapticsTest
{
    class SimpleHapticsTestMain : public DX::IDeviceNotify
    {
    public:
        SimpleHapticsTestMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~SimpleHapticsTestMain();
