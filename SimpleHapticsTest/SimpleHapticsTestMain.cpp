#include "pch.h"
#include "SimpleHapticsTestMain.h"
#include "Common/DirectXHelper.h"

#include <windows.graphics.directx.direct3d11.interop.h>

using namespace SimpleHapticsTest;
...
SimpleHapticsTestMain::SimpleHapticsTestMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&SimpleHapticsTestMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&SimpleHapticsTestMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&SimpleHapticsTestMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void SimpleHapticsTestMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&SimpleHapticsTestMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&SimpleHapticsTestMain::OnCameraRemoved, this, _1, _2));
...
void SimpleHapticsTestMain::UnregisterHolographicEventHandlers()
{
...
SimpleHapticsTestMain::~SimpleHapticsTestMain()
{
...
HolographicFrame SimpleHapticsTestMain::Update()
{
...
bool SimpleHapticsTestMain::Render(HolographicFrame const& holographicFrame)
{
...
void SimpleHapticsTestMain::SaveAppState()
{
    //
...
void SimpleHapticsTestMain::LoadAppState()
{
    //
...
void SimpleHapticsTestMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void SimpleHapticsTestMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void SimpleHapticsTestMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void SimpleHapticsTestMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void SimpleHapticsTestMain::OnCameraAdded(
...
void SimpleHapticsTestMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void SimpleHapticsTestMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void SimpleHapticsTestMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void SimpleHapticsTestMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&SimpleHapticsTestMain::OnLocatabilityChanged, this, _1, _2));
